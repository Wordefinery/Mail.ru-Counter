...
class Wordefinery_MailruCounterWidget extends WP_Widget {
    function __construct() {
        $this->plugin = Wordefinery::Plugin('MailruCounter');
        parent::__construct(
            'wordefinery_mailrucounter_widget',
            wr___('Rating@Mail.ru Counter'),
            array(
                'description' => wr___('Rating@Mail.ru Counter Widget')
            )
        );
    }
...
<!-- //Rating@Mail.ru counter --></div></div><?php
    ...
    function form( $instance ) {
        ...
        ?>
        <p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php wr__e('Title'); ?>:</label>
