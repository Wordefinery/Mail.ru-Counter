...
<form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><?php _e('Site Identifier') ?></th>
                    <td>
                    <input type="text" size="40" name="wordefinery[site_id]" id="<?php echo $this->plugin_slug; ?>-site_id" value="<?php echo $this->store->site_id; ?>" />
                    <input type="button" class="button" id="<?php echo $this->plugin_slug; ?>-check_site_id" value="<?php _e( 'Check Site Id'); ?>" />
                    ...
                    <input type="button" class="button" id="<?php echo $this->plugin_slug; ?>-get_site_id" value="<?php _e( 'Get Site Id'); ?>" />
                ...
                <tr valign="top">
                    ...
                    <?php _e('Shortcode') ?></label> <code>[mailrucounter]</code><br/>
                    <code>&lt;?php do_shortcode('[mailrucounter]') ?&gt;</code> &mdash; <i><?php _e('Use this code in your template') ?></i><br/>
                    </td>
                </tr>
            </table>
